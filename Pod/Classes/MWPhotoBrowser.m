...
- (void)performLayout {
    ...
    // Left button - Grid
    //    if (!_enableGrid) {//modified by Simon Back, swap grid button with custom edit button, original line uncommented
    //        hasItems = YES;
    ...
    //Custom stuff by Simon:
    [items addObject: _actionButton]; //share
    [items addObject:flexSpace];
    [items addObject:[[UIBarButtonItem alloc] initWithImage:[UIImage imageForResourcePath:@"MWPhotoBrowser.bundle/UIBarButtonItemGrid" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] style:UIBarButtonItemStylePlain target:self action:@selector(likeButtonPressed)]]; //like
    [items addObject:flexSpace];
    [items addObject:[[UIBarButtonItem alloc] initWithImage:[UIImage imageForResourcePath:@"MWPhotoBrowser.bundle/UIBarButtonItemGrid" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] style:UIBarButtonItemStylePlain target:self action:@selector(editButtonPressed)]]; //edit
    [items addObject:flexSpace];
    [items addObject:[[UIBarButtonItem alloc] initWithImage:[UIImage imageForResourcePath:@"MWPhotoBrowser.bundle/UIBarButtonItemGrid" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] style:UIBarButtonItemStylePlain target:self action:@selector(deleteButtonPressed)]];//müll
    //
    
    //uncommented by simon because we dont want the additional flexible space
    //    // Middle - Nav
    ...
    //Uncommented by Simon because we want the sharing/actionbutton on the bottom right
    ...
    BOOL hideToolbar = NO;//Change by Simon: previously yes;
...
//Custom functions by simon
- (void)likeButtonPressed {
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"This is a like button?"
                                                    message:@"More info..."
                                                   delegate:self
...
- (void)editButtonPressed {
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Bild bearbeiten"
                                                    message:@"More info..."
                                                   delegate:self
